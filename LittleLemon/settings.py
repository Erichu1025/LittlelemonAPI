...
SECRET_KEY = 'django-insecure-^1l6u3a8tpz35-lt*gkmad=_d8cwf8g!ax(0a-pbsslc+$#p&f'
...
LOGIN_REDIRECT_URL = '/cart/'  # Redirects user to the cart page after login
LOGOUT_REDIRECT_URL = '/'      # Redirects user to the homepage after logout
